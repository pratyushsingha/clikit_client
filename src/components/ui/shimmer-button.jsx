...
const ShimmerButton = React.forwardRef((
  {
    theme = "dark", // New prop to switch themes
    shimmerColor = "#ffffff",
    shimmerSize = "0.05em",
    shimmerDuration = "3s",
    borderRadius = "100px",
    background = theme === "dark" ? "rgba(0, 0, 0, 1)" : "rgba(255, 255, 255, 1)", // White theme background
    className,
    children,
    ...props
  },
  ...
  const textColor = theme === "dark" ? "text-white" : "text-black"; // Conditional text color
  ...
  return (
    <button
      ...
      className={cn(
        ...
        textColor, // Apply text color based on theme
